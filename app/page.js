        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-6">
            ...
            <div className="mt-6 rounded-xl border border-slate-800 p-4">
              <div className="font-semibold">What makes this different from “Startup Arena”</div>
              <ul className="mt-2 list-disc pl-5 text-sm text-slate-300 space-y-1">
                <li>Starts with compliance + skills, not fundraising.</li>
                <li>Tracks coaching sessions and action plans.</li>
                <li>Finance readiness module for banks/MFIs/SACCOs.</li>
                <li>Designed for SIDO Hub operations and donor reporting.</li>
              </ul>
            </div>
          </div>
        </div>
